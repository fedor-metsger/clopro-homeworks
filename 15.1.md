...
в котором описана: 
- [VPC](src/main.tf)
- публичная подсеть [public](src/main.tf)
- приватная подсеть [private](src/main.tf)
- NAT инстанс [nav-vm](src/main.tf)
- виртуалка с публичным IP [public-vm](src/main.tf)
- таблица маршрутизации [nat-rt](src/main.tf)
- виртуалка без публичного IP [private-vm](src/main.tf)
